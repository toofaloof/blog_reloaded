export default function Books() {
  return (
    <>
      ...
      <section style={{ marginTop: "2rem", paddingBottom: "4rem" }}>
        <ul style={{ paddingLeft: "1.2rem", lineHeight: 1.9 }}>
          <li>Requiem for a Dream — Hubert Selby</li>
          <li>Three Body Problem — Liu Cixin</li>
          <li>Foundation — Isaac Asimov</li>
          <li>The Pleasure of Finding Things Out — Richard Feynmann</li>
          ...
          <li>Sextus — Henry Miller</li>
          <li>Kopfarbeit — Peter Vajkoczy</li>
