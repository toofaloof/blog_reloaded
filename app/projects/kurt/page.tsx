  ...
  return (
    <>
      ...
      <section style={{ marginTop: "1rem" }}>
        <p>
          I have been mixing and mastering for nearly 7 years now mixing and mastering sound for underground trap artists, indie game studios
          and audio books.
        </p>   
        <p>
        ...
        Obviously there is something in the physicality of analog gear that can’t be replicated digitally, but its astonishing how far digital emulations - like FabFilter Saturn 2 or Waves CLA compressor - have come, simulating the warmth of tape saturation or the unique character of vintage compressors using mostly signal processing.
        </p>
        <p>
          ...
          The creative process is iterative and the artist needs to be involved in every step of the way. And we see that with attempts like Suno shifting from text-to-audio to a more interactive model where the user can guide the generation process (Suno Studio)
          or AI-first DAWs like Mozart AI. 
        </p>
        <p>
    ...
    "Fruity Limiter_T0_S9": {
      ...
      "params": [0.0, 1.0, 0.93, ...]
        ...
        <p>
          ...
          Another interesting usecase could be the live music generation where a model generates instrument parts in real-time based on a musicians input and the musician can guide the generation by providing feedback on the mix. Deepmind proposed something similar with their livemusic model where a user can toggle the stems of a generated track in real-time.
        </p>
        ...
        <p>
          It is available on Huggingface. Current conditioning is based on audio retrieval from LLM, text prompts, style tags, BPM and key that we get from the DAW and the user. Future work will include audio-injection to further guide the generation process. 
        </p>
